...
.score-container.component-auto-list { width: 40%; min-width: 500px; padding-bottom: 15%; font-size: 14px; overflow: hidden; background: rgba(255, 255, 255, .6); border-radius: 5px; border: solid 1px #ddd; position: relative;
