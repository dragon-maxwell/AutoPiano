...
<template>
  <div class="component-page-header clearfix" ref="PageHeaderComponent">
    <a class="trade-mark" target="_blank" href="/">
      ...
      <h1 class="trade-mark-txt">
        Sky光遇音乐
        <span class="trade-mark-txt--en">skysheetmusic.com</span>
      </h1>
    </a>
    ...
    <div style="float:right;width: 100%;display: flex;justify-content: center;">
      <img
        src="../assets/images/logo.png"
        alt="扫描前往小程序"
        style="height: 160px;width: 510px;margin-top: 90px;margin-bottom: 10px;"
      />
    </div>
  </div>
</template>
